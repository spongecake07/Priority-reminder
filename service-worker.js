const CACHE='priority-reminders-v17';
const ASSETS=['./','./index.html','./styles.css','./nav-polish.css?v=17','./app.js?v=17','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
