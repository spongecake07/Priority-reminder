const CACHE='priority-reminders-v20';
const ASSETS=['./','./index.html','./styles.css','./nav-polish.css?v=20','./app.js?v=20','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
