const CACHE='priority-reminders-v23';
const ASSETS=['./','./index.html','./styles.css','./nav-polish.css?v=23','./app.js?v=23','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
