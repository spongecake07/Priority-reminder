const CACHE='priority-reminders-v13';
const ASSETS=['./','./index.html','./styles.css','./nav-polish.css?v=13','./app.js?v=13','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
