const CACHE='priority-reminders-v19';
const ASSETS=['./','./index.html','./styles.css','./nav-polish.css?v=19','./app.js?v=19','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
