const CACHE='priority-reminders-v21';
const ASSETS=['./','./index.html','./styles.css','./nav-polish.css?v=21','./app.js?v=21','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
