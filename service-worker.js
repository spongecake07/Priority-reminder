const CACHE='priority-reminders-v12';
const ASSETS=['./','./index.html','./styles.css','./nav-polish.css?v=12','./app.js?v=12','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
