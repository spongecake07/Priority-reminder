const CACHE='priority-reminders-v22';
const ASSETS=['./','./index.html','./styles.css','./nav-polish.css?v=22','./app.js?v=22','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
