const CACHE='priority-reminders-v4';
...
self.addEventListener('fetch',event=>{
  ...
  const appShell=url.origin===self.location.origin&&(url.pathname.endsWith('/')||/\/(index\.html|styles\.css|app\.js|manifest\.json)$/.test(url.pathname));
  if(appShell){
