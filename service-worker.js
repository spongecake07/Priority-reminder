const CACHE='priority-reminders-v15';
const ASSETS=['./','./index.html','./styles.css','./nav-polish.css?v=15','./app.js?v=15','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
