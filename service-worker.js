const CACHE='priority-reminders-v25';
const ASSETS=['./','./index.html','./styles.css','./nav-polish.css?v=25','./app.js?v=25','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
