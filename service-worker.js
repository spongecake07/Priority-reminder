const CACHE='priority-reminders-v24';
const ASSETS=['./','./index.html','./styles.css','./nav-polish.css?v=24','./app.js?v=24','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
