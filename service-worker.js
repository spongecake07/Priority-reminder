const CACHE='priority-reminders-v18';
const ASSETS=['./','./index.html','./styles.css','./nav-polish.css?v=18','./app.js?v=18','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
