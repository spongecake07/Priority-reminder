const CACHE='priority-reminders-v14';
const ASSETS=['./','./index.html','./styles.css','./nav-polish.css?v=14','./app.js?v=14','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
