const CACHE='priority-reminders-v16';
const ASSETS=['./','./index.html','./styles.css','./nav-polish.css?v=16','./app.js?v=16','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
